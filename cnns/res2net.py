""" 
PyTorch implementation of Res2Net: A New Multi-scale Backbone Architecture

As described in https://arxiv.org/pdf/1904.01169
...
if __name__ == '__main__':
    ...
    model = res2net101_26w_4s(pretrained=False)
    y = model(x)
    print(y.shape)